...
CREATE TABLE `reservations` (
  ...
  `restaurant_id` varbinary(16) NOT NULL,
  `created_at` datetime(6) NOT NULL,
  `updated_at` datetime(6) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `index_reservations_on_user_id` (`user_id`),
  KEY `index_reservations_on_restaurant_id` (`restaurant_id`),
  CONSTRAINT `fk_rails_0d6bc84231` FOREIGN KEY (`restaurant_id`) REFERENCES `restaurants` (`id`),
